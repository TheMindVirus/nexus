...
namespace Unity.LEGO.Minifig
{
    public class MinifigController : MonoBehaviour
    {
        ...
        public void SetHorizontal(float hx) { Horizontal = hx; }
        public void SetVertical(float vy) { Vertical = vy; }
        public void SetOrbital(float oz) { Orbital = oz; }
        ...
        protected virtual void Update()
        {
            ...
            if (inputEnabled)
            {
                    ...
                    case InputType.Tank:
                        {
                            ...
                            var targetRotateSpeed = Horizontal;
                    ...
                    case InputType.Direct:
                        {
                            ...
                            //var targetSpeed = right * Input.GetAxisRaw("Horizontal"); ///!!!BUG: Hardcoded Input Source
                            //targetSpeed += forward * Input.GetAxisRaw("Vertical");
                            
                            var targetSpeed = (right * Horizontal) + (forward * Vertical);
                ...
                cancelSpecial = !Mathf.Approximately(Vertical, 0) || !Mathf.Approximately(Horizontal, 0) || (Orbital > 0.0f);
